package nl.saxion.disaster.municipality_service.architecture;
 ...
 * and layered architecture for the Municipality Service.
 */
@AnalyzeClasses(
    packages = "nl.saxion.disaster.municipality_service",
...
public class ArchitectureFitnessTest {
     ...
     */
    @ArchTest
    static final ArchRule municipality_service_bounded_context_isolation =
        noClasses()
            .that().resideInAPackage("nl.saxion.disaster.municipality_service..")
            ...
            .because("Municipality Service is a bounded context and must not depend on other services' models");
