package nl.saxion.disaster.regionservice.architecture;
 ...
 * and layered architecture for the Region Service.
 */
@AnalyzeClasses(
    packages = "nl.saxion.disaster.regionservice",
...
public class ArchitectureFitnessTest {
     ...
     */
    @ArchTest
    static final ArchRule region_service_bounded_context_isolation =
        noClasses()
            .that().resideInAPackage("nl.saxion.disaster.regionservice..")
            ...
            .because("Region Service is a bounded context and must not depend on other services' models");
