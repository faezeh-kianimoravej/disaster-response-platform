package nl.saxion.disaster.user_service.architecture;
 ...
 * and layered architecture for the User Service.
 */
@AnalyzeClasses(
    packages = "nl.saxion.disaster.user_service",
    importOptions = ImportOption.DoNotIncludeTests.class
)
public class ArchitectureFitnessTest {

    /**
     * Enforces layered architecture: Controllers/Initializers → Services → Repositories.
     */
    @ArchTest
    static final ArchRule layer_dependencies_are_respected = layeredArchitecture()
        .consideringAllDependencies()
        .layer("Controller").definedBy("..controller..")
        .layer("Initializer").definedBy("..configuration.initializer..")
        ...
        .whereLayer("Initializer").mayNotBeAccessedByAnyLayer()
        .whereLayer("Service").mayOnlyBeAccessedByLayers("Controller", "Initializer")
     ...
     */
    @ArchTest
    static final ArchRule user_service_bounded_context_isolation =
        noClasses()
            .that().resideInAPackage("nl.saxion.disaster.user_service..")
            ...
            .because("User Service is a bounded context and must not depend on other services' models");
