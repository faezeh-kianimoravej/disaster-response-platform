package nl.saxion.disaster.deploymentservice.architecture;
 ...
 * and layered architecture for the Deployment Service.
 */
@AnalyzeClasses(
    packages = "nl.saxion.disaster.deploymentservice",
...
public class ArchitectureFitnessTest {
     ...
     */
    @ArchTest
    static final ArchRule deployment_service_bounded_context_isolation =
        noClasses()
            .that().resideInAPackage("nl.saxion.disaster.deploymentservice..")
            ...
            .because("Deployment Service is a bounded context and must not depend on other services' models");
