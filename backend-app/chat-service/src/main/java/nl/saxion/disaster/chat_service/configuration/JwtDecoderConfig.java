package nl.saxion.disaster.chat_service.configuration;
...
/**
 * Provides a JwtDecoder bean for validating Keycloak-issued tokens without enabling
 * the full Spring Security filter chain. Uses JWKs exposed by the configured issuer.
 */
@Configuration
