package nl.saxion.disaster.chat_service.architecture;
 ...
 * and layered architecture for the Chat Service.
 */
@AnalyzeClasses(
    packages = "nl.saxion.disaster.chat_service",
...
public class ArchitectureFitnessTest {
     ...
     */
    @ArchTest
    static final ArchRule chat_service_bounded_context_isolation =
        noClasses()
            .that().resideInAPackage("nl.saxion.disaster.chat_service..")
            ...
            .because("Chat Service is a bounded context and must not depend on other services' models");
