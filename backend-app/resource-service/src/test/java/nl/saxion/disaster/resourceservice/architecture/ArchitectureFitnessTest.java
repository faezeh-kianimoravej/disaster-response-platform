package nl.saxion.disaster.resourceservice.architecture;
 ...
 * and layered architecture for the Resource Service.
 */
@AnalyzeClasses(
    packages = "nl.saxion.disaster.resourceservice",
...
public class ArchitectureFitnessTest {
     ...
     */
    @ArchTest
    static final ArchRule resource_service_bounded_context_isolation =
        noClasses()
            .that().resideInAPackage("nl.saxion.disaster.resourceservice..")
            ...
            .because("Resource Service is a bounded context and must not depend on other services' models");
