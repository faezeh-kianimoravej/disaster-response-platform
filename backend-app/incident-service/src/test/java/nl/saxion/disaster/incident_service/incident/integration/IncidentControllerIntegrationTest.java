...
/**
 * Integration Tests for Incident Controller REST API Contracts
 *
 ...
 *
 * These tests run in parallel with property-based tests (see IncidentControllerPropertyTest).
 * Teams can choose which test suite to run based on CI/CD needs:
 * - Integration tests validate full HTTP contracts (slower but realistic)
 * - Property tests validate model constraints (faster, no infrastructure)
 */
@Tag("integration")
@SpringBootTest(
