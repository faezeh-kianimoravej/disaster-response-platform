package nl.saxion.disaster.incident_service.architecture;
 ...
 * and layered architecture for the Incident Service.
 */
@AnalyzeClasses(
    packages = "nl.saxion.disaster.incident_service",
...
public class ArchitectureFitnessTest {
     ...
     */
    @ArchTest
    static final ArchRule incident_service_bounded_context_isolation =
        noClasses()
            .that().resideInAPackage("nl.saxion.disaster.incident_service..")
            ...
            .because("Incident Service is a bounded context and must not depend on other services' models");
