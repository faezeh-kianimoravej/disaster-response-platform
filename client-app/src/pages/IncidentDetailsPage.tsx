            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="flex items-center justify-between mb-4">
                    <div className="flex gap-3 items-center">
                        ...
                        } className="text-sm">Priority: {incident.severity}</Badge>
                        <Badge variant="default" className="text-sm">GRIP: {incident.gripLevel}</Badge>
                    </div>
                    ...
                    <div className="flex items-center">
                        <nav className="text-sm text-blue-600">
                            ...
                            <span className="mx-2 text-gray-300">|</span>
                            <a href="#" className="hover:text-blue-800 hover:underline">Assign</a>
                            <span className="mx-2 text-gray-300">|</span>
                            <a href="#" className="hover:text-blue-800 hover:underline">Chat</a>
                        </nav>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600 mb-4">{incident.location} • {incident.status}</p>

                    <div className="mb-6">
                        <div className="flex justify-between items-start mb-2">
                            <div>
                                <h4 className="font-semibold">Description</h4>
                                <div className="text-sm text-gray-500">Reported at: {incident.reportedAt.toLocaleString()}</div>
                            </div>
                        </div>
