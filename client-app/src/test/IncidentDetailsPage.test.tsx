...
describe("IncidentDetailsPage", () => {
  ...
  it("shows loading state initially", async () => {
    (incidentApi.getIncidentById as any).mockReturnValue(
  ...
  it("renders incident details when data is found", async () => {
    ...
    await waitFor(() =>
      expect(screen.getByText(/bridge collapse/i)).toBeInTheDocument()
    );
    ...
    expect(
      screen.getByText(/main bridge partially collapsed/i)
    ).toBeInTheDocument();
